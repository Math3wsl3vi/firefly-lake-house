...
<div className="container mx-auto px-4 py-8">
  ...
  <div className="sm:hidden">
    {/* Main large image */}
    <div
      className="w-full h-[250px] rounded-lg overflow-hidden mb-2 cursor-pointer relative group"
    ...
    {/* Other images in 2 columns */}
    <div className="grid grid-cols-2 gap-2">
      {accommodation.images.slice(1, 5).map((img: string, idx: number) => (
        <div
          key={idx}
          className="cursor-pointer relative group overflow-hidden h-[150px]"
          onClick={() => {
  ...
  <div className="hidden sm:grid grid-cols-4 grid-rows-2 gap-2 h-[500px] rounded-lg overflow-hidden">
    {/* Main large image */}
    <div
